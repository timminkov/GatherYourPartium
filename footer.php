<footer id="footer">
  <div class="wrap">
    <section id="footer-siteinfo">
      <p>Design and development by <a href="http://lunchtime.org.uk">Rob Welch</a> with help from <a href="http://www.cenix.co.uk">Daniel Morgan</a>. Logo by <a href="http://livewareblog.wordpress.com/">Aleksander Adamkiewicz</a>. Social Icons by <a href="http://ctrla.lt/">Ctrl+Alt+Design</a>.</p>
      <p>All content is owned by the author. Site design released under a <a href="<?php bloginfo('template_url'); ?>/license.txt">KYGMOYGPL</a> license. GYP is run by volunteers, <a href="<?php get_home_url(); ?>/apply">find out how you can get involved!</a></p>
    </section>
