...
//Edit: it no longer does this as of WordPress 3.9. Thanks, Automattic.
...
// Force excerpt to be displayed in the wordpress editor (credit: Rev. Voodoo)
...
" );
*/
// Global custom fields (I think this is by Chris Coiyer, again!)
?><?php
...
function add_gcf_interface() {
  add_options_page('Change Cover Image', 'Change Cover Image', '8', 'functions', 'editglobalcustomfields');
}
...
function editglobalcustomfields() {
  ...
  <p><strong>Image URL (relative to gatheryourparty.com):</strong><br />
  <input type="text" name="imageurl" size="55" value="<?php echo get_option('imageurl'); ?>" /></p>

  <p><input type="submit" name="Submit" value="Save" /></p>

  <input type="hidden" name="action" value="update" />
  <input type="hidden" name="page_options" value="imageurl" />
